...
# endif
        ...
        public static void HierarchyWindowCallback(int instanceID, Rect selectionRect)
        {
            ...
            if(go != null && go.GetComponent<GameAnalytics>() != null)
            {
                ...
                UnityEngine.Graphics.DrawTexture(new Rect(GUILayoutUtility.GetLastRect().width - selectionRect.height - 5 - addX, selectionRect.y, selectionRect.height, selectionRect.height), GameAnalytics.SettingsGA.Logo);
            }
        }
